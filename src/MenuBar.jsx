function Menu(){
    return(
        <>
        <div>
            <img class="w-38 h-23 mx-20 my-5" src="/rssbLogo.png"/>
        </div>

        <div class="flex  absolute top-23 left-190 gap-12">
            <div class="flex gap-3">
                <img class="w-11" src="/1bd2921e-e6b8-4671-a25f-ee73540eb80e.svg"/>
                <div>
            ...
            <div class="flex gap-3">
                <img class="w-11" src="/86b5625e-5ffe-4730-8792-5891da1e16fb.svg"/>
                <div>
