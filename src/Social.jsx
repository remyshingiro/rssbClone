function Social(){
    return(
        ...
        <div class="bg-gray-300  h-170">
            <img class="w-150 h-100 absolute left-162 mt-40 shadow-2xl" src="src/assets/public.jpeg"/>
        </div>

        <div class="absolute top-300 ml-9">
        ...
        <div class="text-xl text-gray-600 absolute top-320 ml-9">
        ...
        <div class="bg-blue-900 text-white font-bold w-40 h-10 absolute top-370 ml-39 rounded-md">
            <button class="absolute top-2 ml-8">Get Started</button>
        </div>
        </>
    )
}
