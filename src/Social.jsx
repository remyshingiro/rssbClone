function Social(){
    return(
        ...
        <div class="absolute top-340 ml-9">
        ...
        <div class="text-xl text-gray-600 absolute top-360 ml-9">
        ...
        <div class="bg-blue-900 text-white font-bold w-40 h-10 absolute top-400 ml-20 rounded-md">
